...
class ReportBuilder:
    ...
    def calculate_profit(self): pass
...
class MonthlyReportBuilder(ReportBuilder):
    ...
    def calculate_profit(self):
        self.report.profit = self.report.income - self.report.expenses
    def apply_tax(self, rate):
        self.report.tax=self.report.profit * rate
        self.report.net_income = self.report.profit - self.report.tax
    def get_result(self):
        return self.report
