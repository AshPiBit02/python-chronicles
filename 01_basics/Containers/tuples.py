...
# Access the value for key (3,4)
print(d[(3,4)])

# 7. Function Return 
# Write a function that returns both sum and product of two numbers as a tuple.
...
# 8. Advanced
# Given student record as tuples:
students=[("Aashish",21,"Nepal"),("John",22,"USA"),("Luka",20,"India")]
# Print all names
for student in students:
    print(student[0])
# Find the student from "Nepal"
for student in students:
    if student[2]=="Nepal":
        print(student[0])
